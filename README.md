...
This is a online book shop project developed with PHP framework (CodeIgniter). This application is like online books market place, where user allows to buy and sell their books. Here user can also get different typs of e-books based on the category.
...
4. Admin will monitor whole the system.
...
**Note:** The database name of this project is **"ebookshop"** and **ebookshop.sql** file is inside the tool folder. If you want to clone and use the project, then after clone rename the base folder as **"E-Bookshop"**. Otherwise this application will not work properly. For more query related to this project, contact me through email.
